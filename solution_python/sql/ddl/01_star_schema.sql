...
CREATE TABLE IF NOT EXISTS dim_clients (
    ...
    client_id         VARCHAR(50),   -- business key from clients.csv
...
CREATE TABLE IF NOT EXISTS dim_products (
    ...
    product_code      VARCHAR(50),   -- business key
...
CREATE TABLE IF NOT EXISTS fct_health_lapses (
    ...
    -- Surrogate FKs (nullable for staging)
    client_key            INT,
    product_key           INT,
    lapse_date_key        INT,
    reinstatement_date_key INT,
    ...
    lapse_status          VARCHAR(50) DEFAULT 'LAPSED',
    lapse_reason          VARCHAR(200),
    days_to_reinstatement INT,
